...
Entity.prototype.Attack = function(target) {
	var killedNum, targetNum, winner, loser;
	...
	console.log("Entity #" + targetNum + "(" + winner.GetFitness() + 
		") has killed entity #" + killedNum + "(" + loser.GetFitness() + ")");
};
